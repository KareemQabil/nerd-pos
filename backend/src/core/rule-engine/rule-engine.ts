...
import { IBusinessRule, IRuleResult, IRuleContext } from './business-rule.interface';

export class RuleViolationError extends Error {
    constructor(
        public readonly violations: IRuleResult[],
    ) {
...
export class RuleEngine {
    ...
    async evaluate<TContext extends IRuleContext>(context: TContext): Promise<IRuleResult[]> {
    ...
    async enforceRules<TContext extends IRuleContext>(context: TContext): Promise<void> {
