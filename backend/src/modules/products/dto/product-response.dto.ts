...
export class ProductResponseDto {
    ...
    @Expose()
    @ApiProperty({ description: 'Product name in Arabic', example: 'طبق شاورما' })
    nameAr: string;
    ...
    @Expose()
    @ApiPropertyOptional({ description: 'Product description in Arabic', example: 'طبق شاورما لحم مع الأرز والسلطة' })
    descriptionAr?: string;

    @Expose()
    @ApiProperty({ description: 'Selling price', example: 35.00 })
    price: number;
    ...
    @Expose()
    @ApiPropertyOptional({ description: 'Last updated timestamp', example: '2024-01-20T14:45:00Z' })
    updatedAt?: Date;
}
...
export class ProductListItemDto {
    ...
    @Expose()
    @ApiProperty({ example: 'SHWR-001' })
    sku: string;

    @Expose()
    @ApiProperty({ example: 'Shawarma Plate' })
    name: string;

    @Expose()
    @ApiProperty({ example: 'طبق شاورما' })
    nameAr: string;
    ...
    @Expose()
    @ApiPropertyOptional({ example: '723e4567-e89b-12d3-a456-426614174006' })
    categoryId?: string;
    ...
    @Expose()
    @ApiPropertyOptional({ example: 'https://cdn.example.com/shawarma.jpg' })
    imageUrl?: string;
}
