...
describe('UsersService', () => {
    ...
    describe('login', () => {
        it('should return auth result for valid credentials', async () => {
            ...
            expect(eventBus.publish).toHaveBeenCalledWith('UserLoggedIn', expect.anything());
        });

        it('should throw UnauthorizedException for invalid username', async () => {
            repo.findByUsername.mockResolvedValue(null);

            await expect(service.login('invalid', 'password'))
    ...
    describe('createUser', () => {
        it('should create user with hashed password', async () => {
            ...
            expect(eventBus.publish).toHaveBeenCalledWith('UserCreated', expect.anything());
        });
    });
    ...
    describe('hasPermission', () => {
        it('should return true if user has permission', async () => {
            repo.findUserPermissions.mockResolvedValue(['products.create', 'products.update']);
