// Settings DTOs
import { IsString, IsNumber, IsOptional, IsBoolean, IsArray, IsObject, IsEmail } from 'class-validator';
...
export class CreateTaxSettingDto {
    ...
    @IsOptional() @IsArray() @IsString({ each: true }) exemptCategories?: string[];
