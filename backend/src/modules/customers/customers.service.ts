...
import { Customer, CustomerWithTier, CustomerAddress, LoyaltyTier } from './entities/customers.entity';
...
export class CustomersService {
    ...
    async redeemPoints(customerId: string, pointsToRedeem: number): Promise<number> {
        ...
        await this.eventBus.publish(
            ...
            new LoyaltyPointsRedeemedEvent(customerId, points.toNumber(), discount.toNumber()),
        );
    ...
    async updateTier(id: string, dto: UpdateLoyaltyTierDto): Promise<LoyaltyTier> {
