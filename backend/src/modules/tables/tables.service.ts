...
import { Floor, FloorWithTables, Table, TableReservation } from './entities/tables.entity';
...
export class TablesService {
    ...
    async getReservationsByTable(tableId: string, date: Date): Promise<TableReservation[]> {
